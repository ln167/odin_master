...
This is the official example from `content/sources/tier3-community/odin-examples/arena_allocator/arena_allocator.odin:1-51`, lightly trimmed. It loads three files into an arena, prints them, then frees the whole arena in one shot.
...
This is the pattern shown in `content/wiki/concepts/arena-allocator.md:3-6` and described in `docs-overview.md:3433` ("dynamic arrays and `map` both contain a custom allocator … the allocator from the current `context` will be assigned").
...
- `content/sources/tier1-authoritative/odin-lang-org/docs-overview.md:3431-3454, 3517-3548`
- `content/sources/tier3-community/odin-examples/arena_allocator/arena_allocator.odin:1-51`
- `~/odin/dist/core/mem/virtual/arena.odin:8-12, 42, 49, 246, 323`
- `content/sources/tier2-curated/karl-zylinski/posts-dynamic-arrays-and-arenas.md:37, 89`
- `content/wiki/concepts/arena-allocator.md:3-6`
