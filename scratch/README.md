...
Throwaway directory for "I want to try a thing." Nothing here is tracked
except `scratch.odin` and this README, every other `*.odin` file is
gitignored.
...
`<leader>op` — opens `scratch/scratch.odin` in the current window.
