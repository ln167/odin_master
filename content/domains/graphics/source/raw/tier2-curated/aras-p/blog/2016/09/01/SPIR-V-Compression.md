---
source_url: https://aras-p.info/blog/2016/09/01/SPIR-V-Compression
source_id: aras-p-blog
fetched_at: 2026-05-16T17:32:24.097417+00:00
fetcher: html_mirror
sha256: 223efe1bfcd10e35f8f235fb2859f135c15e95f9d5a8c7bdb9739b835f4cc07d
---

SPIR-V Compression ·  Aras' website
...
*TL;DR: Vulkan SPIR-V shaders are fairly large. ****[SMOL-V](https://github.com/aras-p/smol-v) can make them smaller.*
...
1. **Interleave bits** of the original word so that these common ones (opcode + lenght) take up lowest
...
shaders *(thanks [@baldurk](https://twitter.com/baldurk), [@AlenL](https://twitter.com/AlenL) and
[@basisspace](https://twitter.com/basisspace) for providing and letting me use shaders from The Talos Principle and DOTA2)*.
...
*(*) Note: about 2/3rds of the shader set (Talos & DOTA2) were already processed by spirv-remap; I don’t have unprocessed shaders from these games.
