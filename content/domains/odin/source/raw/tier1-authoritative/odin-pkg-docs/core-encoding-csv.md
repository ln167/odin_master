package encoding/csv - pkg.odin-lang.org 
...
Current Package: *[encoding\_csv](/core/encoding/csv)*
...
1. [core](/core)
2. encoding
3. [csv](/core/encoding/csv)

# package core:encoding/csv [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv)
...
* [Reader\_Error\_Kind](#Reader_Error_Kind)
* [Writer](#Writer)

Constants (1)

* [DEFAULT\_RECORD\_BUFFER\_CAPACITY](#DEFAULT_RECORD_BUFFER_CAPACITY)

Variables (1)

* [reader\_error\_kind\_string](#reader_error_kind_string)

Procedures (14)

* [is\_io\_error](#is_io_error)
* [iterator\_last\_error](#iterator_last_error)
* [iterator\_next](#iterator_next)
* [read](#read)
* [read\_all](#read_all)
* [read\_all\_from\_string](#read_all_from_string)
* [read\_from\_string](#read_from_string)
* [reader\_destroy](#reader_destroy)
* [reader\_init](#reader_init)
* [reader\_init\_with\_string](#reader_init_with_string)
* [write](#write)
* [write\_all](#write_all)
...
### [Errorʦ](#Error) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L88)
...
* [is\_io\_error](/core/encoding/csv/#is_io_error)



##### Related Procedures With Returns

* [iterator\_last\_error](/core/encoding/csv/#iterator_last_error)
* [iterator\_next](/core/encoding/csv/#iterator_next)
* [read](/core/encoding/csv/#read)
* [read\_all](/core/encoding/csv/#read_all)
* [read\_all\_from\_string](/core/encoding/csv/#read_all_from_string)
* [read\_from\_string](/core/encoding/csv/#read_from_string)

### [Readerʦ](#Reader) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L14)
...
* [read](/core/encoding/csv/#read)
* [read\_all](/core/encoding/csv/#read_all)
* [reader\_destroy](/core/encoding/csv/#reader_destroy)
* [reader\_init](/core/encoding/csv/#reader_init)
* [reader\_init\_with\_string](/core/encoding/csv/#reader_init_with_string)

### [Reader\_Errorʦ](#Reader_Error) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L80)
...
### [Reader\_Error\_Kindʦ](#Reader_Error_Kind) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L66)
...
### [Writerʦ](#Writer) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/writer.odin#L8)
...
* [write](/core/encoding/csv/#write)
* [write\_all](/core/encoding/csv/#write_all)
* [writer\_flush](/core/encoding/csv/#writer_flush)
* [writer\_init](/core/encoding/csv/#writer_init)

## Constants

### [DEFAULT\_RECORD\_BUFFER\_CAPACITYʦ](#DEFAULT_RECORD_BUFFER_CAPACITY) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L93)
...
### [reader\_error\_kind\_stringʦ](#reader_error_kind_string) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L73)
...
### [is\_io\_errorʦ](#is_io_error) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L165)
...
is\_io\_error checks where an Error is a specific io.Error kind

### [iterator\_last\_errorʦ](#iterator_last_error) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L144)
...
for record, row\_idx in csv.iterator\_next(&r) { ... }

### [iterator\_nextʦ](#iterator_next) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L136)
...
### [readʦ](#read) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L152)
...
### [read\_allʦ](#read_all) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L176)
...
read\_all reads all the remaining records from r.
Each record is a slice of fields.
read\_all is defined to read until an EOF, and does not treat EOF as an error

### [read\_all\_from\_stringʦ](#read_all_from_string) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L213)
...
read\_all reads all the remaining records from the provided input.

### [read\_from\_stringʦ](#read_from_string) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L197)
...
### [reader\_destroyʦ](#reader_destroy) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L119)
...
reader\_destroy destroys a Reader

### [reader\_initʦ](#reader_init) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L96)
...
reader\_init initializes a new Reader from r

### [reader\_init\_with\_stringʦ](#reader_init_with_string) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin#L112)
...
reader\_init\_with\_string initializes a new Reader from s

### [writeʦ](#write) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/writer.odin#L31)
...
### [write\_allʦ](#write_all) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/writer.odin#L118)
...
write\_all writes multiple CSV records to w using write, and then flushes (if necessary).

### [writer\_flushʦ](#writer_flush) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/writer.odin#L127)
...
writer\_flush flushes the underlying io.Writer.
If the underlying io.Writer does not support flush, nil is returned.

### [writer\_initʦ](#writer_init) [*Source*](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/writer.odin#L19)
...
writer\_init initializes a Writer that writes to w
...
* [doc.odin](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/doc.odin)
* [reader.odin](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/reader.odin)
* [writer.odin](https://github.com/odin-lang/Odin/tree/master/core/encoding/csv/writer.odin)

## Generation Information

Generated with `odin version dev-2026-04 (vendor "odin") Windows_amd64 @ 2026-04-19 21:26:47.335121700 +0000 UTC`
