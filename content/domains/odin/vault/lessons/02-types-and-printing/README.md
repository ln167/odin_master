...
## Find more like this
    just substrate-search --bm25 "fmt.printf verbs" --top 5
    just substrate-search --bm25 "type inference" --top 5

## Next: `content/domains/odin/vault/lessons/03-procedures-and-multiple-returns/`
