...
## Find more like this
    just substrate-search --bm25 "fixed array" --top 5
    just substrate-search --bm25 "array programming" --top 5

## Next: `content/domains/odin/vault/lessons/06-slices/` *(stub for now — fill it in as you work it)*
